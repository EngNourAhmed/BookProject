        ...
        <div class="custom-container">
            <div class="search-navbar">
                <div class="search-bar">
                    <form action="{{ route('articles.index') }}" method="GET" class="d-flex gap-2 w-100">
                        <input
                            type="text"
                            name="search"
                    ...
                    <table class="table table-responsive table-borderless bg-white shadow-sm users-table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ $article->user->name ?? 'غير معروف' }}</td>
                                        ...
                                        <ul class="dropdown-menu text-end">
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    data-form="approve-form-{{ $article->id }}"
                                                    data-title="هل أنت متأكد؟"
                                                    data-text="سيتم قبول المقال!"
                                                    data-confirm="نعم، قم بالقبول">
                                                    قبول المقال
                                                </button>

                                                <form id="approve-form-{{ $article->id }}"
                                                    action="{{ route('articles.approve', $article->id) }}"
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    data-form="reject-form-{{ $article->id }}"
                                                    data-title="هل أنت متأكد؟"
                                                    data-text="سيتم مسح المقال من قاعدة البيانات نهائيا!"
                                                    data-confirm="نعم، ارفضه">
                                                    رفض
                                                </button>
