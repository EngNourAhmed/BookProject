...
<head>
    ...
    <title>My Articles - Book ERA</title>
    <!-- Bootstrap Icons -->
    ...
    <div class="main-content" id="mainContent">
        <div class="header-banner mb-4">
            <div class="d-flex align-items-center justify-content-between bg-glass p-4 rounded-4 border border-white-5 border-opacity-10">
                <div>
                    <h2 class="text-white fw-bold mb-1">My Masterpieces</h2>
                    <p class="text-white-50 small mb-0">Your published works presented in premium edition.</p>
                </div>
        ...
        <div class="container-fluid py-4">
            <div class="row g-4">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="article-card">
                        <div class="card-body d-flex flex-column">
                            <span class="category-badge">Edition: Original</span>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-auto">
                                <div class="author-info d-flex align-items-center">
                                    <div class="avatar-sm me-2" style="width: 32px; height: 32px; background: rgba(255, 214, 10, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                        <i class="bi bi-pen text-accent"></i>
                                    </div>
                                    <div>
                                        <p class="author-name fw-bold mb-0 text-white">You</p>
                ...
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-white-50">Publish a new article to see it here in its premium glory!</p>
                </div>
                @endforelse
            </div>
        </div>
